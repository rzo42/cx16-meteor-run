...
10 bt=255:by=bt+1:cb=$a040:pb=$a240:rb=$A008:y1=$9fe0:y2=y1+1
20 fort=0to7:ct(t)=cb+(t*64):pt(t)=pb+(t*128):nextt
...
50 cl=peek(rb-8):pl=peek(rb-7):nl=peek(rb-6):nd=ti+nl
